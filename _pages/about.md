...
The work I am most proud of from this chapter is a collaboration with [Prof. David Sinclair](https://sinclair.hms.harvard.edu/) at Harvard Medical School — one of the world's foremost researchers on the biology of aging. Together, we produced what we believe is among the first life sciences papers conducted end-to-end with AI collaboration: from data curation and hypothesis generation through analysis, interpretation, and writing. Working from large-scale ARCHS4 transcriptomic data, K-Dense surfaced novel biological insights in hours that took us days to verify by hand, compressing roughly one year of conventional research effort into three weeks — a 15-20x acceleration. The paper introduces new biological aging clocks that outperform strong baselines, and a first-of-its-kind confidence metric that lets the system recognize when its own predictions are likely to be wrong — a property with real clinical potential. This collaboration is the clearest proof-of-concept I have for what AI-driven science can become.

Beyond that, I spend my time building the infrastructure that makes this kind of science possible: foundation models trained on large biological datasets, autonomous multi-agent analysis pipelines, and methods for extracting calibrated and interpretable knowledge from high-dimensional biological measurements. The goal is always the same: compress the timelines of biological discovery, and make the kind of science that usually takes decades take months.
